...
public class Total_UI : MonoBehaviour
{
    ...
    public IEnumerator initializeUI(List<Agent> agentsInOrder, Roster rost)
    {
        yield return playerbase.initialize(agentsInOrder, rost.simulatedTotalRosterSize);
    }
    ...
    // It doesn't look pretty, but I cannot think of a better way to ensure all listening conditional UI elements have received the action.
